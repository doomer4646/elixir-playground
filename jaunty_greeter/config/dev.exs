...
config :jaunty_greeter, JauntyGreeterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "peVj2jVH3yjJlQzjQ1oPoxFkaR3tvrBD350Ir3XAJFgwke05L5ceESRr/hUl1op8",
  watchers: [
...
config :jaunty_greeter, JauntyGreeterWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/jaunty_greeter_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :jaunty_greeter, dev_routes: true
